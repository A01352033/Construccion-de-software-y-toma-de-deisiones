...
router.get('/modificar', tacosController.get_modificar);

router.get('/modificar/:id', tacosController.get_modificar);

router.post('/modificar/:id', tacosController.post_modificar);
